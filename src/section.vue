<template>
    <div class="duo_A container-fluid">
        <!-- wwManager:start -->
...
.duo_A .section-subtitle {
    margin-top: 10px;
    margin-bottom: 60px;
}

.duo_A .block-container {
    margin-bottom: 10px;
}
...
.duo_A .section-padding {
    padding: 30px 15px
}

.duo_A .block-img-container {
    position: relative;
    width: 100%;
    min-height: 1px;
    padding-right: 15px;
